...
use Dan\Jobfair\Domain\Model\Contact;
...
class JobTest extends UnitTestCase {
	...
	public function setSectorForObjectStorageContainingSectorSetsSector() {
		$sector = new Sector();
		$objectStorageHoldingExactlyOneSector = new ObjectStorage();
	...
	public function setEducationForObjectStorageContainingEducationSetsEducation() {
		...
		$objectStorageHoldingExactlyOneEducation = new ObjectStorage();
	...
	public function setFeuserForObjectStorageContainingUserSetsFeuser() {
		$feuser = new User();
		$objectStorageHoldingExactlyOneFeuser = new ObjectStorage();
