...
.. container:: table-row
	...
	Description
		Sets the minimum number of jobs which are neccessary for the filter to appear. E.g. if set to 20 the filter will
not appear if there are only 15 jobs present, but will show if there are 25 entries.
